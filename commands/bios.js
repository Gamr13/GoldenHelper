...
const exampleEmbed = new MessageEmbed()
	...
	.setDescription("Before reading this, make sure you know how to connect to your Xbox by following /ftp or /mfe first!\n\n1) Connect to your Xbox and open LOCALFOLDER > The RetroArch folder\n2) Open the System folder\n3) Place all of your BIOS files **EXCEPT** your PS2 and Wii/GC BIOS files in here.\n\n4) Create a pcsx2 folder and a bios folder inside that, now place your PS2 BIOS in here (We recommend SCPH-39001).\n Now creare a cheats and cheats_ws folder](https://i.imgur.com/V5KiBok.png) in the pcsx2 folder next to the bios folder you just created, or else your games will just black screen or crash.\n5) Go back to system and open / create the Dolphin-emu folder, [place the Sys folder in here](https://i.imgur.com/4REGrem.png).\n\n And that's it, you're done!")
	.setTimestamp()
