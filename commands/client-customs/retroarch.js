...
const exampleEmbed = new EmbedBuilder()
	...
	.setDescription('Welcome to the RetroArch Guide.')
		.addFields(
		{ name: '\u200B', value: '\u200B' },
		{ name: 'Step 1)', value: 'Inside RetroArch, go to Main Menu > Online Updater and update **everything**', inline: false },
		...
		{ name: 'NOTE:', value: 'For a USB setup, you **MUST** follow /usbperms for new drives or every time a drive is formatted.', inline: false },
